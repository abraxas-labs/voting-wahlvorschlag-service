...
namespace Eawv.Service.Migrations
{
    ...
    [Migration("20181219154650_TemplatesEmptyCandidates")]
    partial class TemplatesEmptyCandidates
    {
...
", Filename = "@Model.Election.Name - Kandidaten.pdf", Format = 0, Landscape = true, Type = 0 },
                        new { Id = new Guid("709a8ef6-9d5e-c029-ddaa-346ea4021b43"), Content = @"@using Eawv.Service.DataAccess.Entities
@using RazorLight
@using System.Linq
@using System
@inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
...
", Filename = "@Model.Election.Name - Kandidaten (leer).pdf", Format = 0, Landscape = true, Type = 1 }
                    );
                });
