...
namespace Eawv.Service.Migrations
{
    ...
    [Migration("20181220132442_TemplateEmailNotifications")]
    partial class TemplateEmailNotifications
    {
            ...
            modelBuilder.Entity("Eawv.Service.DataAccess.Entities.TemplateEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("3464ef11-14e5-9cbb-fcc5-fd31fc1704fd"), Content = @"<html>
  <head>
    <meta charset=""UTF-8"" />
    <style>
      body {
...
", Format = 0, Key = "BaseLayout", Landscape = false, Type = 0 },
                        new { Id = new Guid("a148bd7e-0f06-7117-5de1-6956113f1b06"), Content = @"@{
    Layout = ""BaseLayout"";
}
...
@RenderBody()", Format = 0, Key = "BaseLayoutHeader", Landscape = false, Type = 0 },
                        new { Id = new Guid("7473694c-6143-646e-6964-61746573242d"), Content = @"@using Eawv.Service.DataAccess.Entities
@using RazorLight
@using System.Linq
...
</main>", Filename = "@Model.Election.Name - Kandidaten.pdf", Format = 0, Landscape = true, Type = 1 },
                        new { Id = new Guid("906ac8af-b905-0d33-1f03-a462c66f0387"), Content = @"@using Eawv.Service.DataAccess.Entities
@using RazorLight
@using System.Linq
@inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
@{
...
</main>", Filename = "@Model.Election.Name - Kandidaten (leer).pdf", Format = 0, Landscape = true, Type = 2 },
                        new { Id = new Guid("6e676953-7461-726f-6965-73242d000000"), Content = @"@using RazorLight
@inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
@{
    ViewBag.Model = Model;
    Layout = ""BaseLayout"";
...
}", Filename = "@Model.Election.Name - Unterzeichnende.pdf", Format = 0, Landscape = true, Type = 4 },
                        new { Id = new Guid("17213c83-88e6-69a2-7f34-a3b716acfda5"), Content = @"@inherits RazorLight.TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
@{
    ViewBag.Model = Model;                                                                     
    Layout = ""BaseLayoutHeader"";
}
...
</main>", Filename = "@Model.Election.Name - Listenverbindungen (leer).pdf", Format = 0, Landscape = true, Type = 3 },
                        new { Id = new Guid("f5021674-afce-9c2c-a533-8a401bb3f2e4"), Content = @"@using RazorLight
@inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
<h2>Guten Tag</h2>
...
", Filename = "@Model.Election.Name - Statuswechsel Wahlvorschlag", Format = 0, Landscape = false, Type = 5 },
                        new { Id = new Guid("4bec31bf-5e45-7b3c-710e-bd4213a24856"), Content = @"@using RazorLight
@inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
<h2>Guten Tag</h2>
...
<br />
Diese Nachricht wurde automatisch generiert.
", Filename = "@Model.Election.Name - Eingang Kommentar", Format = 0, Landscape = false, Type = 6 }
                    );
                });
