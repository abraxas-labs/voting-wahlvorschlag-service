...
public partial class TemplateListCandidatesv11 : Migration
{
              ...
              <div class=""row col-main"">
                ...
                <div class=""grow col"">
                  ...
                  <span class=""small hint""
                    >Allfällige Parteikürzel voranstellen! Keine Trennzeichen
                    zwischen Parteikürzel und ausführlicher Bezeichnung.</span
                  >
                </div>
              </div>
              <div class=""row col-right"">
                <div class=""no-shrink"">Kurzbezeichnung des Wahlvorschlags:</div>
                <div class=""col grow space"">
                  <div class=""input w-6 fullwidth"">
                    <input />
                    <div class=""border""></div>
                  </div>
                  <span class=""small right hint"">(max. 6 Zeichen)</span>
                </div>
              </div>
            </div>
            <div class=""row space"">
              ...
              <div class=""row center col-right stretch"">
