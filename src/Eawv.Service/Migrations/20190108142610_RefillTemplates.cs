...
public partial class RefillTemplates : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                ...
                { new Guid("0ea74799-d3fa-c8ea-b7e6-af290716b6c8"), @"@using Eawv.Service.DataAccess.Entities
                @using RazorLight
                @using System.Linq
                ...
                }", "@Model.Election.Name - Kandidaten.csv", 0, null, false, null, 2 },
                ...
                </main>", "@Model.Election.Name - Kandidaten (leer).pdf", 0, null, true, null, 3 },
                ...
                }", "@Model.Election.Name - Unterzeichnende.pdf", 0, null, true, null, 5 },
                ...
                </main>", "@Model.Election.Name - Listenverbindungen (leer).pdf", 0, null, true, null, 4 },
                { new Guid("f5021674-afce-9c2c-a533-8a401bb3f2e4"), @"@using RazorLight
                @inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
                <h2>Guten Tag</h2>
                ...
                ", "@Model.Election.Name - Statuswechsel Wahlvorschlag", 0, null, false, null, 6 },
                { new Guid("4bec31bf-5e45-7b3c-710e-bd4213a24856"), @"@using RazorLight
                @inherits TemplatePage<Eawv.Service.Models.TemplateServiceModels.TemplateBag>
                <h2>Guten Tag</h2>
                ...
                <br />
                Diese Nachricht wurde automatisch generiert.
                ", "@Model.Election.Name - Eingang Kommentar", 0, null, false, null, 7 }
            });
    }
